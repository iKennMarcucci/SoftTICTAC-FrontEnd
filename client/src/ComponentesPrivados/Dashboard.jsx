...
function Dashboard() {
   ...
   return showDashboard && (
      <>
         ...
         <div className="flex">
            <div className={`fixed h-full bg-blue-100 border-t-2 border-blue-200 ${isOpen ? 'w-72' : 'w-36 max-sm:w-0'} transition-all duration-300`}>
               ...
               <div className={`p-4 w-full ${!isOpen && 'max-sm:scale-0'}`}>
...

                  {
                     crearAccordionOpen && (
                        <ul>
                           <li className={`cursor-pointer rounded-md hover:font-light mb-1 px-2 hover:bg-blue-300 py-1`}>
                              <Link id='herramientas' to={'/controlpanel/#'} className={`flex items-center ${!isOpen && "justify-center"}`}>
                                 <svg
                           ...
                           <li className={`cursor-pointer rounded-md hover:font-light mb-1 px-2 hover:bg-blue-300 py-1`}>
                              <Link id='contenidos' to={'/controlpanel/#'} className={`flex items-center ${!isOpen && "justify-center"}`}>
                                 <svg
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-5 h-5">
                           ...
                           <li className={`cursor-pointer rounded-md hover:font-light mb-1 px-2 hover:bg-blue-300 py-1`}>
                              <Link id='proy-aula' to={'/controlpanel/#'} className={`flex items-center ${!isOpen && "justify-center"}`}>
                                 <svg
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-5 h-5">
                           ...
                           <li className={`cursor-pointer rounded-md hover:font-light mb-1 px-2 hover:bg-blue-300 py-1`}>
                              <Link id='plan-trabajo' to={'/controlpanel/#'} className={`flex items-center ${!isOpen && "justify-center"}`}>
                                 <svg
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-5 h-5">
                           ...
                           <li className={`cursor-pointer rounded-md hover:font-light mb-1 px-2 hover:bg-blue-300 py-1`}>
                              <Link id='estadisticas' to={'/controlpanel/#'} className={`flex items-center ${!isOpen && "justify-center"}`}>
                                 <svg
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-5 h-5">
