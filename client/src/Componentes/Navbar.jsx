...
function Navbar() {
   ...
   const cerrarSesion = async () => {
      console.log("asiognasgnasgnosaignoignaongsaon");
                     ...
                     <div className="relative ml-3">
                        ...
                        </button>
                        {
                           ...
                           >
                              ...
                              <Link to="/pedidos" className="flex px-4 py-2 text-sm not-italic font-normal text-gray-700" role="menuitem" tabIndex="-1" id="user-menu-item-0">
